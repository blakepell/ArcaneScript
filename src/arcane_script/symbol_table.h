...
ARCANE_INTERNAL symbol_t* symbol_make(allocator_t* alloc, const char* name, symbol_type_t type, int index,
                                      bool assignable);
ARCANE_INTERNAL void symbol_destroy(symbol_t* symbol);
ARCANE_INTERNAL symbol_t* symbol_copy(symbol_t* symbol);

ARCANE_INTERNAL symbol_table_t* symbol_table_make(allocator_t* alloc, symbol_table_t* outer,
                                                  global_store_t* global_store, int module_global_offset);
...
ARCANE_INTERNAL const symbol_t*
symbol_table_define_function_name(symbol_table_t* st, const char* name, bool assignable);
