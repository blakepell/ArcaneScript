...
ARCANE_INTERNAL const char* object_get_type_name(object_type_t type);
ARCANE_INTERNAL char* object_get_type_union_name(allocator_t* alloc, object_type_t type);
