...
ARCANE_INTERNAL vm_t* vm_make(allocator_t* alloc, const arcane_config_t* config, gcmem_t* mem, errors_t* errors,
                              global_store_t* global_store); // config can be null (for internal testing purposes)
